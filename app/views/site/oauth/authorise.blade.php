...
<form method="POST" action="{{action('OauthController@action_authorise')}}" accept-charset="UTF-8">
  <input type="hidden" name="_token" value="{{{ Session::getToken() }}}">
                      Allow {{Client::where('id',Session::get('client_id'))->first()->name}} to access this information?<br/><br/>
...
<!--
  ...
  -->
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" type="submit" name="approve" value="approve"><i class="glyphicon glyphicon-ok-sign"></i> Authorize</button>
                                <button class="btn btn-lg" type="submit" name="deny" value="deny"><i class="glyphicon glyphicon-repeat"></i> Deny</button>
                            </div>
                      </div>
                </form>
</div>
